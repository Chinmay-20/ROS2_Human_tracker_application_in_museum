...
""" this script allows robot to follow yellow line using camera input, processing images with OpenCV, adjusting its velocity a"""
class LineFollower(Node):
    ...
    def camera_callback(self, msg: Image) -> None:
        ...
        rows_to_watch = 20
        # Crop image 
        # we crop image as its crucial to operate with smallest image size necessary for task enhancing sped of detection system
