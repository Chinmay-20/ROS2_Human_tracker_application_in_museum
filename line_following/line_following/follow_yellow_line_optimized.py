...
""" in this code it optimizes centroid calculation to handle scenarios where multiple yellow paths are present """
""" updated to detect multiple centriods when encountering multiple yellow paths. we will select most appropriate centriod to guide robot's movement ensuing it navigates around museum instead of heading towards door. """
...
class LineFollowerOptimized(Node):
    ...
    def camera_callback(self, msg: Image) -> None:
        ...
        # we find contours within binary mask.
        # contours represent continuous regions of non zero pixels in image
        # we compute centroids for each contour
        # centriods are added to centres list
        # we fraw green circle for each detected centroid. 
        ...
        # 
        # Retrieves appropriate centroid from centres list by selecting one with maximum x-coordinate then retrieve corresponding x & y coorindates.
