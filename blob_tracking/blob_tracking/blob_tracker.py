...
class BlobTracker(Node):
    def __init__(self) -> None:
        ...
        # subscribes to /point_blob topic to receive blob coordinates 
        # adjust robot's velocities based on blob's position
        # publishes command to guide robot towards exit door
        # no blob is detected it rotates robot continuously until an orange blob is found 
